...
while True:
    ...
    while True : # Valida el ingreso del DNI
        try:
            ...
            print("❌ Asegurese de ingresar un numero de documento valido sin letras ! ❌\n\n")
    ...
    while True : # Valida el ingreso del Telefono
        try:
            ...
            print("❌ Asegurese de ingresar un numero de telefono valido sin letras ! ❌\n\n")
    print("➖" * 70)
    ...
    while True:
        try:
            desea_continuar = float(input(f"¿Desea continuar ? Recuerde solo ingresar 1 o 2\n\t\t1 - Si.\n\t\t2 - No.\n\n\n> > > "))
            if desea_continuar == 2 or desea_continuar == 1:
                    break

        except ValueError:
            print("RECUERDE INGRESAR 1 o 2")
